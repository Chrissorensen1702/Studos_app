  ...
  <section class="page">
    ...
    <div class="home-grid">
      <section id="opret-klasse" class="panel">
        ...
        @if ($activeMembership)
          <div class="empty-state">
            <strong>Du er allerede medlem af {{ $activeMembership->class_name }}</strong>
            <span>Admin er kun til ejere og moderatorer. Brug en separat ejerkonto, hvis du skal oprette en ny klasse.</span>
          </div>
        @else
      ...
      <section class="panel">
        ...
        <div class="empty-state">
          @if ($activeMembership)
            <strong>Ingen admin-adgang</strong>
            <span>Din nuværende rolle er {{ ucfirst($activeMembership->current_role) }}.</span>
          @else
