...
const APP_TOP_BAR_HEIGHT = Platform.OS === 'ios' ? 100 : 58 + ANDROID_STATUS_BAR_HEIGHT;
const APP_TOP_BAR_PADDING_TOP = Platform.OS === 'ios' ? 42 : ANDROID_STATUS_BAR_HEIGHT;
const APP_TOP_BAR_PADDING_BOTTOM = Platform.OS === 'ios' ? 8 : 0;
const APP_FOOTER_PADDING_BOTTOM = Platform.OS === 'android' ? 54 : 8;
const APP_SCREEN_PADDING = 20;
const APP_SCREEN_TOP_PADDING = 30;
const APP_FOOTER_HEIGHT = 10 + 52 + APP_FOOTER_PADDING_BOTTOM;
const CHAT_THREAD_TOP_PADDING = Platform.OS === 'ios' ? 54 : ANDROID_STATUS_BAR_HEIGHT + 14;
const CHAT_THREAD_BOTTOM_PADDING = Platform.OS === 'android' ? APP_FOOTER_PADDING_BOTTOM : 10;
